...
import { Users, BookOpen, Cpu, GraduationCap, Briefcase, Award, ShieldCheck, ChevronDown, ChevronUp, Building2 } from "lucide-react";
  ...
  return (
    <section id="about" className="section-padding relative" aria-label="About Dr. Abhishek Gupta">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        {/* Primary Row: Bio Card (3 cols) + Expertise Card (2 cols) */}
        <div className="grid lg:grid-cols-5 gap-6 sm:gap-8 items-start">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
            className="lg:col-span-3 ios-glass-card rounded-[28px] p-6 sm:p-9 shadow-md flex flex-col justify-between"
          >
            <div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5 mb-6 pb-6 border-b border-black/[0.06]">
                <div className="relative w-18 h-18 sm:w-22 sm:h-22 rounded-2xl overflow-hidden border-2 border-white shadow-md shrink-0 bg-indigo-50">
                  <Image
                    src={professor.photo}
                ...
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-zinc-900 tracking-tight">
                    Educator, Placement Leader & Technology Strategist
                  </h3>
                </div>
              </div>

              <div className="space-y-3.5 text-zinc-600 text-sm sm:text-[0.92rem] leading-relaxed">
                <p>
                  ...
                  disciplines with applied software systems and industry placement outcomes.
                </p>
                <p>
                  Serving across recognized leadership appointments as{" "}
                  ...
                  Dr. Gupta actively prepares students for technological excellence while contributing peer-reviewed research in IEEE and Scopus.
                </p>
              </div>
                  ...
                  return (
                    <div key={role.title} className="flex gap-3 items-start p-3 rounded-2xl bg-white/50 border border-white/80 hover:bg-white/80 transition-colors">
                      ...
                      <div>
                        ...
                        <p className="text-zinc-500 text-[0.73rem] leading-snug">{role.desc}</p>
                      </div>
                    </div>
                  );
                })}
          ...
          <motion.div
            ...
            className="lg:col-span-2 ios-glass-card rounded-[28px] p-6 sm:p-9 shadow-md flex flex-col justify-between"
          >
            <div>
              <span className="inline-flex items-center gap-1.5 text-[0.72rem] font-bold text-indigo-700 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-3 py-1 mb-4 self-start">
                Areas of Expertise
              </span>

              <h3 className="text-xl font-bold text-zinc-900 tracking-tight mb-1.5">Core Disciplines</h3>
              <p className="text-zinc-500 text-[0.84rem] mb-5 leading-relaxed">
              ...
              <div className="space-y-2 flex-1">
                {professor.expertise.map((domain) => (
                  <div
                    key={domain.id}
                    className="flex items-center gap-3 p-2.5 sm:p-3 rounded-xl border border-zinc-100 bg-zinc-50/60 hover:bg-white hover:border-zinc-200 transition-all duration-200 cursor-default"
                  >
                    <span
                      className="w-2.5 h-2.5 rounded-full flex-shrink-0"
                      style={{ background: domain.color }}
                    />
                    <span className="font-semibold text-zinc-900 text-[0.84rem] flex-1">
                      {domain.name}
                    </span>
                    <span
                      className={`text-[0.68rem] font-semibold px-2 py-0.5 rounded-full border ${
              ...
              <div className="mt-5 pt-4 border-t border-zinc-100 space-y-2.5">
                <div className="flex items-start gap-2.5 bg-zinc-50 rounded-xl p-2.5 border border-zinc-200/80">
                  <GraduationCap size={17} className="text-indigo-600 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-bold text-zinc-900 text-[0.8rem] leading-tight">
                      M.Tech (CSE) &bull; Arni University
                    </p>
                    <p className="text-zinc-500 text-[0.7rem] mt-0.5">
                      MCA (CS) &bull; Dr. A.P.J. Abdul Kalam Technical University (AKTU)
                    </p>
                  </div>
                </div>

                <div className="flex items-center justify-between gap-2 p-2 rounded-xl bg-emerald-50/60 border border-emerald-200/70 text-[0.72rem]">
                ...
                <div className="flex items-center justify-between gap-2 p-2 rounded-xl bg-red-50/60 border border-red-200/70 text-[0.72rem]">
                ...
                <div className="flex items-center justify-between gap-2 p-2 rounded-xl bg-blue-50/60 border border-blue-200/70 text-[0.72rem]">
        ...
        {/* Expandable Extended Section (Campus Placements & Editorial) */}
        <AnimatePresence>
          {showMore && (
            <motion.div
            ...
            >
              ...
              <div className="ios-glass-card rounded-[28px] p-6 sm:p-8 shadow-md">
              ...
              <div className="flex justify-center pt-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-zinc-100 hover:bg-zinc-200 text-zinc-700 hover:text-zinc-950 text-xs font-semibold transition-colors cursor-pointer"
                >
